...
function createResponseMock({ method = "GET", status = 200, url = linkedInLazyLoadUrl, } = {}) {
    return {
        url: () => url,
        status: () => status,
        request: () => ({
...
describe("waitForLinkedInPage lazy-load scrolling", () => {
    ...
    it("throws when a matching LinkedIn lazy-load response fails", async () => {
        ...
        await expect(scrollLinkedInLazyLoadedJobsUntilComplete(page, {
            responseTimeoutMs: 1,
            scrollSettleMs: 0,
...
//# sourceMappingURL=waitForLinkedInPage.test.js.map