...
function normalizeForContainment(input) {
    return normalizeCoverLetterText(input).replace(/\s+/g, " ").trim();
}
function validateSourcePreservingSegments(sourceText, segments) {
...
export async function segmentCoverLetterWithLlmFallback(normalizedCoverLetterText) {
...
//# sourceMappingURL=coverLetterSegmentationFallback.js.map